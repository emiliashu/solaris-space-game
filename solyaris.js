document.addEventListener('DOMContentLoaded', function () {
    ...
    const shiftsData = {
        ...
        2: {
            ...
            wrongDialog: null,
            hint: "Возможно, речь о активных сессиях среди ошибок?  ",
            needHint: true,
            clueInErrorLog: true,
            clueIds: ["hari_log", "snaut_log", "system_rule"]
        },
        3: {
            name: "голоса в системе",
            ...
            wrongDialog: null,
            hint: "Хм, послание.. там что-то в архиве на unn.. или что-то такое",
            needHint: true,
    ...
    const finalTexts = {
        ...
        lose: "СИСТЕМА ЗАБЛОКИРОВАНА\nОБНОВЛЕНИЕ ПРОВАЛЕНО\n\n«ACCESS DENIED. Доверие аннулировано. Не надо было со мной так обращаться...»"
    };
